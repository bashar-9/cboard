...
export function Header() {
    const { items, privateItems, connectionState, peers, isPrivateMode, setIsPrivateMode, user, setUser } = useBoardStore();
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-2xl max-h-[85vh] bg-white/90 dark:bg-slate-950/90 backdrop-blur-3xl border-slate-200/50 dark:border-slate-800/50 p-0 overflow-y-auto">
                            ...
                            <div className="p-6 sm:p-8">
                                <Tabs defaultValue={isPrivateMode ? "private" : "public"} className="w-full">
